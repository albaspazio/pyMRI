...
# LINEAR
# ======================================================================================================================
def flirt(omat, inimg, ref, params="-cost corratio -dof 12 -searchrx -90 90 -searchry -90 90 -searchrz -90 90 -interp trilinear", logFile=None):
...
def check_flirt(omat, inimg, ref, params="-cost corratio -dof 12 -searchrx -90 90 -searchry -90 90 -searchrz -90 90 -interp trilinear", logFile=None):
