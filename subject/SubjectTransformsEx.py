...
class SubjectTransformsEx:
    ...
    def __init__(self, subject, _global):
        ...
        self.rs2fmri_warp    = os.path.join(self.subject.roi_fmri_dir, "rs2fmri_warp")
        self.fmri2rs_warp    = os.path.join(self.subject.roi_rs_dir, "fmri2rs_warp")
    ...
    def transform_mpr(self, logFile=None):
        ...
        if os.path.isfile(self.hr2std4_mat) is False:
            rrun("flirt -in " + self.subject.t1_brain_data + " -ref " + self.subject.std4_img + " -omat " + self.hr2std4_mat + ".mat -cost corratio -dof 12 -searchrx -90 90 -searchry -90 90 -searchrz -90 90 -interp trilinear")
        ...
        ## => hr2{std}4.nii.gz
        if imtest(self.hr2std4_warp) is False:
            rrun("applywarp -i " + self.subject.t1_data + " -r " + self.subject.std4_img + " -o " + self.hr2std4_warp + " -w " + self.hr2std4_warp)
    ...
    def transform_rs(self, do_bbr=False, wmseg="", logFile=None):
        ...
        if do_bbr is True:
            ...
            # NOT BBR
            if os.path.isfile(self.rs2hr_mat) is False:
                rrun("flirt -in " + exfun + " -ref " + self.subject.t1_brain_data + " -omat " + self.rs2hr_mat + ".mat" + " -cost corratio -dof 6 -searchrx -90 90 -searchry -90 90 -searchrz -90 90 -interp trilinear", logFile=logFile)
    ...
    def transform_fmri(self, do_bbr=False, wmseg="", logFile=None):
        ...
        if do_bbr is True:
            ...
            # NOT BBR
            if os.path.isfile(self.fmri2hr_mat) is False:
                rrun("flirt -in " + exfun + " -ref " + self.subject.t1_brain_data + " -omat " + self.fmri2hr_mat + ".mat" + " -cost corratio -dof 6 -searchrx -90 90 -searchry -90 90 -searchrz -90 90 -interp trilinear", logFile=logFile)
    ...
    def transform_dti_t2(self, logFile=None):
        ...
        if self.subject.hasT2 is False:
            ...
            if imtest(self.dti2std_warp) is False:
                rrun("convertwarp --ref=" + self.subject.std_head_img + " --premat=" + dti2hr + ".mat" + " --warp1=" + self.hr2std_warp + " --out=" + self.dti2std_warp, logFile=logFile)
            ...
            # -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
            if imtest(self.dti2std_warp) is False:
                rrun("convertwarp --ref=" + self.subject.std_head_img + " --warp1=" + self.subject.dti2t2_warp + " --midmat=" + self.subject.hr2t2_mat + ".mat" + " --warp2=" + self.hr2std_warp + " --out=" + self.dti2std_warp, logFile=logFile)
    ...
    def transform_nl_hr2std(self, input_roi, output_roi):
        ...
        rrun("applywarp -i " + input_roi + " -r " + self.std_img + " -o " + output_roi + " --warp=" + warp)
    def transform_l_hr2std(self, input_roi, output_roi):
        ...
        rrun("flirt -in " + input_roi + " -ref " + self.std_img + " -out " + output_roi + " -applyxfm -init " + mat + " -interp trilinear")
    ...
    def transform_l_hr2std4(self, input_roi, output_roi):
        ...
        if os.path.exists(mat) is False:
            print("ERROR: transformation matrix " + mat + " is missing...exiting transform roi")
            return ""
        rrun("flirt -in " + input_roi + " -ref " + self.std4_img + " -out " + output_roi + " -applyxfm -init " + mat + " -interp trilinear")
