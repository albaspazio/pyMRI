...
matlabbatch{2}.spm.tools.cat.stools.results.conspec.threshdesc = 'FWE';
matlabbatch{2}.spm.tools.cat.stools.results.conspec.thresh = 0.05;
matlabbatch{2}.spm.tools.cat.stools.results.conspec.extent = 0;
