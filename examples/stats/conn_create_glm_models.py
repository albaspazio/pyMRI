...
if __name__ == "__main__":
    ...
    try:
        ...
        # ONE GROUP
        # regressors = [Nuisance("age"), Nuisance("gender")]
        # connmodels.create_regressors_file_ofsubset(outfolder, regressors, "all_nk", ["td_nk"], "subset_td_nk_x_age_gender")
        #
        # regressors = [Covariate("FS0"), Covariate("dis_dur")]
        # connmodels.create_regressors_file_ofsubset(outfolder, regressors, "all_nk", ["psi_nk"], "subset_td_nk_FS0_disdur")
        #
        # regressors = [Nuisance("age"), Nuisance("gender"), Covariate("FS0"), Covariate("dis_dur")]
        # connmodels.create_regressors_file_ofsubset(outfolder, regressors, "all_nk", ["psi_nk"], "subset_td_nk_FS0_disdur_x_age_gender")

        # TWO GROUPS
        regressors = [Nuisance("age"), Nuisance("gender")]
        connmodels.create_regressors_file_ofsubset(outfolder, regressors, "all_nk", ["td_nk", "psi_nk"], "subset_td_vs_psi_x_age_gender")
        #
        regressors = [Covariate("FS0"), Covariate("FS1")]
        connmodels.create_regressors_file_ofsubset(outfolder, regressors, "all_nk", ["td_nk", "sk_nk"], "subset_td_vs_sk_fs0_fs1")

        regressors = [Nuisance("age"), Nuisance("gender"), Covariate("FS0"), Covariate("FS1")]
        connmodels.create_regressors_file_ofsubset(outfolder, regressors, "all_nk", ["td_nk", "bd_nk"], "subset_td_vs_bd_fs0_fs1_x_age_gender")

        # THREE GROUPS
        regressors = [Nuisance("age"), Nuisance("gender")]
        connmodels.create_regressors_file_ofsubset(outfolder, regressors, "all_nk", ["td_nk", "sk_nk", "bd_nk"], "subset_td_sk_bd_x_age_gender")

        regressors = [Covariate("FS0"), Covariate("FS1")]
        connmodels.create_regressors_file_ofsubset(outfolder, regressors, "all_nk", ["td_nk", "sk_nk", "bd_nk"], "subset_td_sk_bd_fs0_fs1")
