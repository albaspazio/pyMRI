...
if __name__ == "__main__":
    ...
    try:
        ...
        doplot          = True
        # ==================================================================================================================
        # tbssmaps            = ["tbss_L23_ctrl57_sp_lr_sp_sts_sp_srs_sp_sa_bis_t_x_age_gender_tfce_corrp_tstat4"] # ["tbss_FA_sp_lr_sp_sts_sp_srs_sp_sa_SH_x_age_gender_tfce_corrp_tstat1"]
        tbssmaps            = ["tbss_L23_sp_lr_sp_sts_sp_srs_sp_sa_x_age_gender_tfce_corrp_tstat5"]
        ...
        # define over which tracts the tbss results span and calculate the mean values within each results' subpart
        # ==================================================================================================================
        results = []
        for tbssmap in tbssmaps:
            ...
            # res_file = "/data/MRI/projects/past_controls/group_analysis/tbss/controls57_FMRIB58/results/scatter_tracts_tbss_L23_ctrl57_sp_lr_sp_sts_sp_srs_sp_sa_bis_t_x_age_gender_tfce_corrp_tstat4_age_sp_sts_sp_lr_bis_t.dat"
        ...
        # ==================================================================================================================
        sign_tract_in_tbss  = ["af_r", "atr_l", "atr_r", "cbd_l", "cbp_l", "cst_r", "fa_l", "fa_r", "fma", "fmi", "ilf_r", "ifo_r", "mdlf_r", "or_r", "str_l", "slf1_l", "slf1_r", "slf2_r" , "slf3_r"] #, "cc"]
