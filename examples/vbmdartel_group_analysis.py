...
if __name__ == "__main__":
    ...
    try:
        ...
        vbm_template_dir    = analysis.create_vbm_spm_template_normalize(vbm_template_name, subjects)
        ...
        spm_analysis.batchrun_spm_vbm_dartel_stats_factdes_1group_multregr(vbm_template_dir, anal_name, groups_instances, cov_names, spm_contrasts_template_name="")
        ...
        spm_analysis.batchrun_spm_vbm_dartel_stats_factdes_1Wanova(vbm_template_dir, anal_name, groups_instances, cov_names, spm_contrasts_template_name="")
        ...
        #                                                   spm_contrasts_template_name="", runit=True):
        groups_instances = {"groups_instances":[], "labels":[], "cells": []}
        cov_names   = ["gender", "age"]
        anal_name   = "2Wanova_age_gender"
        spm_analysis.batchrun_spm_vbm_dartel_stats_factdes_2Wanova(vbm_template_dir, anal_name, groups_instances, cov_names, spm_contrasts_template_name="")
        ...
        cov_names   = ["gender", "age"]
        anal_name   = "1Wanova_3_groups_age_gender"
        spm_analysis.batchrun_spm_vbm_dartel_stats_factdes_2samplesttest(vbm_template_dir, anal_name, groups_instances, cov_names, spm_contrasts_template_name="")
