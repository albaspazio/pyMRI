...
class SPMContrasts:
    ...
    @staticmethod
    def create_spm_stats_2samplesttest_contrasts_results(project, _global, spmmat, c1_name="A>B", c2_name="B>A",
                                                         spm_template_name="spm_stats_2samplesttest_contrasts_results",
                                                         mult_corr="FWE", pvalue=0.05, cluster_extend="none"):
        try:
            # create template files
            out_batch_job, out_batch_start = project.create_batch_files(spm_template_name, "mpr")
            ...
            SPMStatsUtils.cat_replace_results_trasformation_string(out_batch_job, 3, mult_corr, pvalue, cluster_extend)
    ...
    # cluster_extend = "none" | "en_corr" | "en_nocorr"
    @staticmethod
    def create_cat_stats_1group_multregr_contrasts_results(project, _global, spmmat, cov_names,
    ...
    @staticmethod
    def create_spm_stats_predefined_contrasts_results(project, _global, statsdir, spm_template_full_path_noext, eng=None):
        try:
            # create template files
            out_batch_job, out_batch_start = project.create_batch_files(spm_template_full_path_noext, "mpr")
