...
class SPMCovariates:
    ...
    @staticmethod
    def spm_replace_stats_add_simplecovariates(project, out_batch_job, groups_instances, covs=None, batch_id=1, cov_interaction=None, datafile=None):
    ...
    # interaction=1 : no interaction, otherwise specify factors (1-based + 1, e.g. first factor = 2)
    @staticmethod
    def spm_replace_stats_add_1cov_manygroups(out_batch_job, groups_labels, project, cov, batch_id=1, cov_interaction=None, datafile=None):
